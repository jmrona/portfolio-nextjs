    ...
    const projects = [
        {
            ...
            urlWebsite: '', 
            skills: [ 'Next JS', 'Bootstrap', 'Framer Motion', 'EmailJS', 'Laravel 8', 'MySQL', 'Laravel Sactum']
        },
        {
            ...
            urlWebsite: '', 
            skills: ['React JS','Redux','SASS','Firebase','Firestore','Google auth','Cloudinary API']
        },
        {
        ...
        },
        {
            ...
            skills: ['React JS','Giphy API','Github Pages']
        },
    ]
...
//     const res = await fetch(`https://backend-portfolio-jmrona.herokuapp.com/api/projects`)
